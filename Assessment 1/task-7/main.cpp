...
void main()
{
    //Using structs and arrays, build a character class and userInput selection system
    ...
    //The character class userInputs and amount are up to you, but should make 
    //use of an array so the solution can be easily extended. Invalid menu choices
    //should also be handled.

    //The user should then be prompted for their in-game userInput, and then their
